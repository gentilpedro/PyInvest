    ...
    return pd.DataFrame(
        {
            ...
            "P/Ativo": [1.0, 2.0, 0.3, 3.0],
            "P/Cap.Giro": [5.0, 10.0, 2.0, 15.0],
            "P/EBIT": [10.0, 20.0, 3.0, 30.0],
            "P/Ativ Circ.Liq": [8.0, 18.0, 2.5, 28.0],
            "EV/EBIT": [9.0, 18.0, 4.0, 27.0],
            "EV/EBITDA": [7.0, 14.0, 3.0, 21.0],
            "Mrg Bruta": [40.0, 30.0, 20.0, 50.0],
            "Mrg Ebit": [20.0, 12.0, -5.0, 28.0],
            "Mrg. Líq.": [12.0, 5.0, -8.0, 20.0],
            "Liq. Corr.": [1.8, 1.3, 0.9, 2.5],
            ...
            "Cresc. Rec.5a": [15.0, 8.0, -3.0, 22.0],
        }
    )
